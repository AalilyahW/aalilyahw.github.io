...
## Proposed Change
Embed an interactive Google Map showing my hometown directly onto the personal introduction webpage.

## Reasons for the Change
The instructor (stakeholder) wants this change to add a feature personalized, interactive geographic element to the webpage, allowing my instructor to see my hometown context.

## How This Change Will Add Value
It enhances user engagement by introducing a visual, interactive multimedia element that breaks up text-heavy content and aligns with modern digital media footprints.
